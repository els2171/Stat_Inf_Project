...
I first simulated 1000 samples of 40 exponentials by using R's exponential distribution and a lambda of 0.2. These samples were then loaded into a 1000 x 40 matrix, where each row corresponds to a sample of 40 exponentials.
...
```{r, fig.width = 2.5, fig.height = 2.5, echo = TRUE}
